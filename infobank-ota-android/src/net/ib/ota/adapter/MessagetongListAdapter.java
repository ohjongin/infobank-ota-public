 ...
 */
public class MessagetongListAdapter extends ParseFileListAdapter {
    public MessagetongListAdapter(Context context, int layout_res_id, ArrayList<ParseObject> file_list) {
